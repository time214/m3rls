/* ********************************************************************************************************************
888b     d888 88888888888 8888888888  .d8888b.   .d8888b.   .d8888b.  888b    888  .d88888b.  8888888b.  8888888b.  
8888b   d8888     888           d88P d88P  Y88b d88P  Y88b d88P  Y88b 8888b   888 d88P" "Y88b 888   Y88b 888   Y88b 
88888b.d88888     888          d88P  888    888      .d88P 888    888 88888b  888 888     888 888    888 888    888 
888Y88888P888     888         d88P   Y88b. d888     8888"  888    888 888Y88b 888 888     888 888   d88P 888   d88P 
888 Y888P 888     888      88888888   "Y888P888      "Y8b. 888    888 888 Y88b888 888     888 8888888P"  8888888P"  
888  Y8P  888     888       d88P            888 888    888 888    888 888  Y88888 888 Y8b 888 888 T88b   888 T88b   
888   "   888     888      d88P      Y88b  d88P Y88b  d88P Y88b  d88P 888   Y8888 Y88b.Y8b88P 888  T88b  888  T88b  
888       888     888     d88P        "Y8888P"   "Y8888P"   "Y8888P"  888    Y888  "Y888888"  888   T88b 888   T88b 
                                                                                           Y8b   
   ******************************************************************************************************************** */
#include "stdafx.h"
#include "math.h"
...
DUT_API int OS_TEST(short funcindex, LPCTSTR funclabel)	{
  ...
  // TODO: Add your function code here
	...
	// VPWR(10)
	//pviVPWR.Set(FI, -1.5e-3, FPVI10_2V, FPVI10_10MA, RELAY_ON);
...
DUT_API int Effective_Resistance(short funcindex, LPCTSTR funclabel)	{
	//{{AFX_STS_PARAM_PROTOTYPES
  CParam *RD = StsGetParam(funcindex,"RD");							// 2-1
  CParam *RD2 = StsGetParam(funcindex,"RD2");						// 2-2
  CParam *iC_CC1 = StsGetParam(funcindex,"iC_CC1");			// 2-3
  CParam *iC_CC2 = StsGetParam(funcindex,"iC_CC2");			// 2-4
  //}}AFX_STS_PARAM_PROTOTYPES
  // TODO: Add your function code here
  	...
  	for(site = 0; site< SITENUM; site++)	{
  		vCC[site] = fabs(pviCC1.GetMeasResult(site, MVRET));
 			if( (flag[site] == 0) && (vCC[site] < vJudgement) )	{
				...
				VOVP1_H[site] += float(0e-3);	// offset
  			flag[site] = 1;
  		}
  	}
  	if( (flag[0] == 1) && (flag[1] == 1) )
  	...
  	for(site = 0; site< SITENUM; site++)	{
  		vCC[site] = fabs(pviCC1.GetMeasResult(site, MVRET));
 			if( (flag[site] == 0) && (vCC[site] > vJudgement) )	{
				...
				VOVP1_L[site] += float(0e-3);	// offset
  			flag[site] = 1;
  		}
  	}
  	if( (flag[0] == 1) && (flag[1] == 1) )
  	...
  	for(site = 0; site< SITENUM; site++)	{
  		vCC[site] = fabs(oviCC2.GetMeasResult(site, MVRET));
 			if( (flag[site] == 0) && (vCC[site] < vJudgement) )	{
				...
				VOVP2_H[site] += float(0e-3);	// offset
  			flag[site] = 1;
  		}
  	}
  	if( (flag[0] == 1) && (flag[1] == 1) )
  	...
  	for(site = 0; site< SITENUM; site++)	{
  		vCC[site] = fabs(oviCC2.GetMeasResult(site, MVRET));
 			if( (flag[site] == 0) && (vCC[site] > vJudgement) )	{
				...
				VOVP2_L[site] += float(0e-3);	// offset
  			flag[site] = 1;
  		}
  	}
  	if( (flag[0] == 1) && (flag[1] == 1) )
...
//#ifdef DEBUG
	...
	// V33E, C_CC2, CC2
	//oviV33E.Set(FV, 0.0f, FOVI_10V, FOVI_100MA, RELAY_ON);
	//oviC_CC2.Set(FV, 0.0f, FOVI_50V, FOVI_1A, RELAY_ON);
	pviCC1.Set(FI, 0.0e-12f, FPVI10_50V, FPVI10_10UA, RELAY_SENSE_ON);
	delay_ms(1);
  ...
  StsGetSiteStatus(sitesta, SITENUM);
	...
	//rlyC.SetOn(VPWR_Cap, V33E_Cap, C_CC2_Fovi, CC2_Fovi, V33E_Fovi, FLTB_100K, VPWR_Fpvi, RPD1_Fovi, RPD2_Fovi, -1);
  ...
  delay_ms(5);
	...
	for(jj = 0; jj < int(loopt); jj++)	{
		for(site = 0; site < SITENUM; site++)	{
			//oviC_CC2.Set(FV, 36.0f, FOVI_50V, FOVI_1A, RELAY_ON);
			//oviCC2.MeasureVI(20, 2);
			//CC2_Clamp_V[site] = oviCC2.GetMeasResult(site, MVRET, MAX_RESULT);
...
DUT_API int CCx_current_limit(short funcindex, LPCTSTR funclabel)	{
  ...
  CParam *CCx_current_limit_response_time = StsGetParam(funcindex,"CCx_current_limit_response_time");
  //}}AFX_STS_PARAM_PROTOTYPES
  ...
  StsGetSiteStatus(sitesta, SITENUM);
	...
	// ******************************* C_CC1 Current Limit ******************************* 6-1
	//rlyC.SetOn(VPWR_Cap, V33E_Cap, V33E_Fovi, VPWR_Fpvi, RPD1_Fovi, RPD2_Fovi, C_CC1_Fpvi, CC1_Fpvi, -1);
 	rlyC.SetOn(VPWR_Cap, V33E_Cap, V33E_Fovi, VPWR_Fpvi, RPD1_Fovi, /*RPD2_Fovi,*/ C_CC1_Fpvi, CC1_Fpvi, FLTB_100K, -1);
  ...
  for(Tmpv = 1000.0f; Tmpv >= 0.0f; Tmpv += -50.0f)
	...
	// ******************************* C_CC2 Current Limit ******************************* 6-2, 6-3
  //rlyC.SetOn(VPWR_Cap, V33E_Cap, V33E_Fovi, VPWR_Fpvi, RPD1_Fovi, RPD2_Fovi, C_CC1_Fpvi, CC1_Fpvi, -1);
 	rlyC.SetOn(VPWR_Cap, V33E_Cap, V33E_Fovi, VPWR_Fpvi, /*RPD1_Fovi,*/ RPD2_Fovi, C_CC2_Fpvi, CC2_Fpvi, FLTB_100K, -1);
...
#ifdef DEBUG
	rlyC.SetOn(VPWR_Cap, V33E_Cap, V33E_Fovi, VPWR_Fpvi, RPD1_Fovi, RPD2_Fovi, C_CC2_Fpvi, CC2_Fpvi, -1);
	delay_ms(1);
...
DUT_API int VBUS_OVP_Mosfet(short funcindex, LPCTSTR funclabel)	{
  ...
  StsGetSiteStatus(sitesta, SITENUM);
	...
	double deltaV[SITENUM] = { 0.0f }, iLoading = 100e-3f, iload[SITENUM] = { 9999, 9999 };
  ...
  for(site = 0; site < SITENUM; site++)	{
    ...
    Ron1_3V6[site]= deltaV[site] / iload[site];//iLoading;
  ...
  for(site = 0; site < SITENUM; site++)	{
		vSBU1out[site] = pviC_SBU1.GetMeasResult(site, MVRET, AVERAGE_RESULT);
    vSBU1in[site] = pviSBU1.GetMeasResult(site, MVRET, AVERAGE_RESULT);
		iload[site] = pviSBU1.GetMeasResult(site, MIRET);
    deltaV[site] = vSBU1in[site] - vSBU1out[site];
	...
	pviC_SBU1.Set(FI, 0, FPVI10_10V, FPVI10_1A, RELAY_ON);
  delay_ms(1);
	pviC_SBU1.Set(FV, 0, FPVI10_10V, FPVI10_1A, RELAY_OFF);
  delay_ms(1);
  ...
  delay_ms(1);
	...
	// ************************************ SBU2 3.6V, C_SBU2 source 100mA ************************************ 7-5
	oviSBU2.Set(FV, 3.6f, FOVI_10V, FOVI_100MA, RELAY_ON);
  delay_ms(1);
	oviC_SBU2.Set(FI, -iLoading, FOVI_10V, FOVI_100MA, RELAY_ON);
  delay_ms(1);
  ...
  for(site = 0; site < SITENUM; site++)	{
	...
	// ************************************ SBU2 0.4V, C_SBU2 source 100mA ************************************ 7-6
	oviSBU2.Set(FV, 0.0f/*0.4f*/, FOVI_10V, FOVI_1A, RELAY_ON);
  delay_ms(10);

	oviSBU2.MeasureVI(1000, 10);
	oviC_SBU2.MeasureVI(1000, 10);
  for(site = 0; site < SITENUM; site++)	{
		vSBU2out[site] = oviC_SBU2.GetMeasResult(site, MVRET, AVERAGE_RESULT);
    vSBU2in[site] = oviSBU2.GetMeasResult(site, MVRET, AVERAGE_RESULT);
		iload[site] = oviSBU2.GetMeasResult(site, MIRET);
    deltaV[site] = vSBU2in[site] - vSBU2out[site];
    Ron2_0V[site]= deltaV[site] / iload[site];//iLoading;
  	...
  	SBUS_Ron_FALT2	->SetTestResult(site, 0, fabs(Ron2_3V6[site]-Ron2_0V[site]));	
		...
		// isuue, double confirm is necessary, circuit route or ?
...
DUT_API int SBU_OVP_Threshold(short funcindex, LPCTSTR funclabel)	{
  ...
  StsGetSiteStatus(sitesta, SITENUM);
	...
	for(Tmpv = 4.0f; Tmpv < 5.35f;)	{
	  ...
	  pviSBU1.MeasureVI(100, 10);	//10,10
  	for(site = 0; site < SITENUM; site++)	{
  ...
  delay_ms(1);
	...
	for(Tmpv = 4.0f; Tmpv < 5.35f;)	{
	  ...
	  oviSBU2.MeasureVI(100, 10);	//10, 10
  	for(site = 0; site < SITENUM; site++)	{
...
DUT_API int QuiescentCurrent(short funcindex, LPCTSTR funclabel)	{
	//{{AFX_STS_PARAM_PROTOTYPES
  CParam *IQ_VBUS = StsGetParam(funcindex,"IQ_VBUS");												// 10-1
  ...
  CParam *CC1I_Leak = StsGetParam(funcindex,"CC1I_Leak");										// 10-2
  ...
  CParam *SBU1I_Leak = StsGetParam(funcindex,"SBU1I_Leak");									// 10-3
  ...
  CParam *CC1I_OVP_3V3_Leak = StsGetParam(funcindex,"CC1I_OVP_3V3_Leak");		// 10-4
  ...
  CParam *CC1O_OVP_3V3_Leak = StsGetParam(funcindex,"CC1O_OVP_3V3_Leak");		// 10-5
  ...
  CParam *SBU1I_OVP_3V3_Leak = StsGetParam(funcindex,"SBU1I_OVP_3V3_Leak");	// 10-6
  ...
  CParam *SBU2I_OVP_3V3_Leak = StsGetParam(funcindex,"SBU2I_OVP_3V3_Leak");	// 10-7
  ...
  for(site = 0; site < SITENUM; site++)	{
	  IQ_V33E->SetTestResult(site, 0, fabs(oviV33E.GetMeasResult(site, MIRET))*1e6f);		
    IQ_VBUS->SetTestResult(site, 0, fabs(oviVBUS.GetMeasResult(site, MIRET))*1e6f);
 	}
	...
	oviVBUS.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)	{
	  IQ2_V33E->SetTestResult(site, 0, fabs(oviV33E.GetMeasResult(site, MIRET))*1e6f);		
	  IQ2_VBUS->SetTestResult(site, 0, fabs(oviVBUS.GetMeasResult(site, MIRET))*1e6f);		
 	}
	pwrZero();
	pwrSW_off();
	delay_ms(1);
  ...
  pviCC1.Set(FV, 0.0f, FPVI10_1V, FPVI10_10UA, RELAY_ON);
	...
	delay_ms(5);
	oviVBUS.Set(FV, 36.0f, FOVI_50V, FOVI_10MA, RELAY_ON);
	oviC_CC2.Set(FV, 36.0f, FOVI_50V, FOVI_100MA, RELAY_ON);
	delay_ms(2);
	oviCC2.Set(FV, 0.0f, FOVI_50V, FOVI_10MA, RELAY_ON);
	delay_ms(2);
	...
	oviC_CC2.MeasureVI(100, 20);
  	for(site = 0; site < SITENUM; site++)
 		  CC2I_OVP_3V3_Leak->SetTestResult(site, 0, fabs(oviC_CC2.GetMeasResult(site, MIRET))*1e6f);		
	...
	oviC_CC2.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)
	  CC2I_OVP_0V_Leak->SetTestResult(site, 0, fabs(oviC_CC2.GetMeasResult(site, MIRET))*1e6f);		
  ...
  pviCC1.Set(FV, 0.0f, FPVI10_1V, FPVI10_10UA, RELAY_ON);
	...
	//rlyC.SetOn(V33E_Cap, VPWR_Cap,V33E_Fovi, VPWR_Fpvi, FLTB_100K, RPD1_Fovi, RPD2_Fovi, C_CC2_Fovi, CC2_Fovi, -1);
	...
	//oviC_CC2.Set(FV, 36.0f, FOVI_50V, FOVI_100MA, RELAY_ON);
	//delay_ms(2);
	//oviCC2.Set(FV, 0.0f, FOVI_50V, FOVI_10UA, RELAY_ON);
	//delay_ms(2);
	...
	pviCC1.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)
	  //CC2O_OVP_3V3_Leak->SetTestResult(site, 0, fabs(oviCC2.GetMeasResult(site, MIRET))*1e9f);		
	...
	pviCC1.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)
	  //CC2O_OVP_0V_Leak->SetTestResult(site, 0, fabs(oviCC2.GetMeasResult(site, MIRET))*1e9f);		
  ...
  pviSBU1.Set(FV, 0.0f, FPVI10_1V, FPVI10_10UA, RELAY_ON);
	...
	oviSBU2.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)	{
		SBU2I_OVP_3V3_Leak->SetTestResult(site, 0, fabs(oviC_SBU2.GetMeasResult(site, MIRET))*1e6f);	// offset 20uA	
	...
	oviSBU2.MeasureVI(100, 20);
	for(site = 0; site < SITENUM; site++)	{
		SBU2I_OVP_0V_Leak->SetTestResult(site, 0, fabs(oviC_SBU2.GetMeasResult(site, MIRET))*1e6f);	// offset 20uA
...
DUT_API int VPWR_CurrentLimit(short funcindex, LPCTSTR funclabel)	{
  ...
  delay_us(100);
 	...
 	for(site = 0; site < SITENUM; site++)
	  CurrentLimit->SetTestResult(site, 0, fabs(iCL[site]*1e3));
...
DUT_API int TOVP_test(short funcindex, LPCTSTR funclabel)	{
  ...
  qtmu0.SetTimeOut(10);
    ...
    qtmu0.SinglePlsMeas(site);
 	...
 	for(site = 0; site < SITENUM; site++)	{
		TOVP_FLT_ASSERTION->SetTestResult(site, 0, (FLT_Down_T[site]));
  	TOVP_FLT_DEASSERTION->SetTestResult(site, 0, (FLT_Up_T[site]*1.0e-3f));
 	}
	pwrZero();
	pwrSW_off();
	rlyC.SetOn(-1);
...
DUT_API int CC_Timing_Test1(short funcindex, LPCTSTR funclabel)	{
  ...
  CParam *Ton_FET_2 = StsGetParam(funcindex,"Ton_FET_2");				// designer: item removed
  CParam *Ton_FET_DB_2 = StsGetParam(funcindex,"Ton_FET_DB_2");	// designer: item removed
  //}}AFX_STS_PARAM_PROTOTYPES
  ...
  int inx=0;
	...
	rlyC.SetOn(FLTB_100K, VPWR_Cap, V33E_Cap, C_CC1_Fpvi, /*C_CC2_Fovi,*/ V33E_Fovi, CC1_qtmuA, V33E_QTMU_B, QTMU_Swap, RPD1_Fovi, /*RPD2_Fovi,*/ -1);
	delay_ms(1);
  ...
  delay_ms(1);
	...
	pviC_CC1.Set(FV, 1.5f, FPVI10_10V, FPVI10_10MA, RELAY_ON);
	//oviC_CC2.Set(FV, 1.5f, FOVI_10V, FOVI_10MA, RELAY_ON);
	oviRPD1.Set(FV, 1.5f, FOVI_10V, FOVI_10MA, RELAY_ON);
	//oviRPD2.Set(FV, 1.5f, FOVI_10V, FOVI_10MA, RELAY_ON);
	delay_ms(10);
  ...
  // ****************************** TON1(CC1) FET DeadBattery ****************************** 18-2
	...
	delay_ms(1);
  qtmu0.SetStartTrigger(2.5f,QTMU_PLUS_POS_SLOPE); 
  qtmu0.SetStopTrigger(0.1f,QTMU_PLUS_POS_SLOPE); 
  delay_ms(1);	
	qtmu0.SetSinglePulseMeas(QTMU_PLUS_COARSE, QTMU_PLUS_TRNG_US);   
  qtmu0.SetTimeOut(10);
	for(site = 0; site < SITENUM; site++)  {
...
DUT_API int CC_Timing_Test2(short funcindex, LPCTSTR funclabel)	{
  ...
  // TODO: Add your function code here
	// C_CC1 Rising(T1), CC1 Falling(T2), Tovp_response=T2-T1
	// C_CC1 Falling(T3), CC1 Rising(T4), Tovp_recovery1=T4-T3
	// C_CC1 Rising(T5), Tovp_recovery=T5-T3	

 //  int flag[SITENUM] = {0};
 // 	BYTE sitesta[SITENUM] = {0};
	//double CC1O_V[2]={0.0f},CC1O_Down_T[2]={0.0f},CC1O_Up_T[2]={0.0f};
 //   double Tovp_RESP_T[2]={0.0f},Tovp_Recovery_CC1FET_T[2]={0.0f},Tovp_Recovery_CC1DB_T[2]={0.0f},Tovp_Recovery_CC2FET_T[2]={0.0f},Tovp_Recovery_CC2DB_T[2]={0.0f};
	//double CC1I_C[2]={0.0f},CC1I_tmp_C[2][2000]={{0.0f},{0.0f}},CC1I_C_T[2]={0.0f};
 //   int inx=0;

	///double CC1O_V[SITENUM] = {0.0f}, CC1O_Down_T[SITENUM] = {0.0f}, CC1O_Up_T[SITENUM] = {0.0f};
  ...
  short inx=0;
	...
	//oviV33E.Set(FV, 0.0f, FOVI_10V, FOVI_100MA, RELAY_ON);
	//oviFLTB.Set(FV, 0.0f, FOVI_10V, FOVI_100UA, RELAY_ON);
	//pviC_CC1.Set(FV, 0.0f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
	//oviRPD1.Set(FV, 0.0f, FOVI_50V, FOVI_10MA, RELAY_ON);//RPD1
 //	delay_ms(1);   //5    delay_ms(1); 
	// 19-1
	////rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC1_QTMU_A, CC1_QTMU_B, FLTB_Fovi, FLTB_100K, RPD1_Fovi, RPD2_Fovi, -1);
	//////rlyC.SetOn(C_CC1_Fpvi, CC1_Fpvi, CC1_Fpvi, FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC1_QTMU_A, CC1_QTMU_B, FLTB_Fovi, FLTB_100K, RPD1_Fovi, RPD2_Fovi, -1);
	////delay_ms(1);

	//oviRPD1.Set(FV, 24.0f, FOVI_50V, FOVI_10MA, RELAY_ON);
	//pviC_CC1.Set(FV, 24.0f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
	//pviCC1.Set(FI, -0.01e-6f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
	//delay_ms(6);
  ...
  ////qtmu0.SetStartTrigger(6.5f, QTMU_PLUS_POS_SLOPE);
  ////qtmu0.SetStopTrigger(1.2f, QTMU_PLUS_NEG_SLOPE);
 	////qtmu0.SetInSource(QTMU_PLUS_DUAL_SOURCE);
  ////qtmu0.Connect();
  ////delay_ms(3);

	////oviFLTB.Set(FV, 3.3f, FOVI_10V, FOVI_1MA, RELAY_ON);
	////oviV33E.Set(FV, 3.3f, FOVI_10V, FOVI_10MA, RELAY_ON);
	////delay_ms(10);

	//pviC_CC1.MeasureVI(500, 10);
	//pviCC1.MeasureVI(500, 10);
	////qtmu0.SetSinglePulseMeas(QTMU_PLUS_FINE, QTMU_PLUS_TRNG_NS);   
 //// qtmu0.SetTimeOut(100);
	////for(site = 0; site < SITENUM; site++)	{
		//rlyC.SetOn(FPVI2_nonKelvin,FPVI2_nonKelvin,VPWR_Cap,V33E_Cap,V33E_Fovi/*,CC1I_QTMU_A*/,/*CC1O_QTMU_B,*/C_CC1_Fpvi,V33E_Cap,FLTB_Fovi,RPD1_Fovi, -1);//
		//rlyC.SetOn(C_CC1_Fpvi, CC1_Fpvi, CC1_Fpvi, FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC1_QTMU_A, CC1_QTMU_B, FLTB_Fovi, FLTB_100K, RPD1_Fovi, RPD2_Fovi, -1);
		////rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC1_QTMU_A, CC1_QTMU_B, C_CC1_Fpvi, V33E_Cap, FLTB_Fovi, RPD1_Fovi, -1);
		//oviRPD1.Set(FV, 8.0f, FOVI_50V, FOVI_10MA, RELAY_ON);
		//pviC_CC1.Set(FV, 8.0f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
...
//#ifdef DEBUG
	...
	delay_ms(2);
  qtmu0.SetStartInput(QTMU_PLUS_IMPEDANCE_1M, QTMU_PLUS_VRNG_25V, QTMU_PLUS_FILTER_10MHz);
  qtmu0.SetStopInput(QTMU_PLUS_IMPEDANCE_1M, QTMU_PLUS_VRNG_25V, QTMU_PLUS_FILTER_10MHz);
  ...
  delay_ms(1);
	...
	rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC1_Fpvi, FLTB_Fovi, RPD1_Fovi, -1);
  // S1K15, S1K2, S2K1, S2K6, S1K9, S1K6, S1K4
	delay_ms(1);
  ...
  for(site = 0; site < SITENUM; site++)	{
 	...
 	for(site = 0; site < SITENUM; site++)	{
		...
		for (inx=0; inx < 1000; inx += 1)	{
			if ((flag[site] == 0) && (CC1I_tmp_C[site][inx] *1.0e6f) <= 150.0f)	{
				CC1I_C_T[site]=inx;
				flag[site] = 1;
			}
			if((flag[0] == 1) && (flag[1] == 1))
    ...
    Tovp_Recovery_CC1DB_T[site]=(CC1I_C_T[site] * 10.0f) - 0.0f;
	}

	// 19-4
	// *************************************** TOVP_Recovery_CC2_FET ***************************************
	rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, /*C_CC1_QTMU_A, CC1_QTMU_B,*/ C_CC2_Fpvi, V33E_Cap, FLTB_Fovi, RPD2_Fovi, -1);
	pviC_CC1.Set(FV, 24.0f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
	oviV33E.Set(FV, 3.3f, FOVI_10V, FOVI_10MA, RELAY_ON);
	delay_ms(2);
  qtmu0.SetStartInput(QTMU_PLUS_IMPEDANCE_1M, QTMU_PLUS_VRNG_25V, QTMU_PLUS_FILTER_10MHz);
  ...
  delay_ms(1);
	...
	qtmu0.Disconnect(); 
  // 19-5
	// *************************************** TOVP_Recovery_CC2_DB ***************************************
	rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, V33E_Cap, V33E_Fovi, C_CC2_Fpvi, FLTB_Fovi, RPD2_Fovi, -1);
	delay_ms(1);
	oviRPD2.Set(FV, 24.0f, FOVI_50V, FOVI_10MA, RELAY_ON);
	pviC_CC1.Set(FV, 24.0f, FPVI10_50V, FPVI10_10MA, RELAY_ON);
	delay_ms(3);
  ...
  for(site = 0; site < SITENUM; site++)	{
    ...
    Tovp_Recovery_CC2DB_T[site]=(CC1I_C_T[site] * 10.0f) - 0.0f;
	}
	for(site = 0; site < SITENUM; site++)	{
		//TOVP_Response_CC			->SetTestResult(site, 0, (Tovp_RESP_T[site] * 1.0e3f));               // 19-1
    TOVP_Recovery_CC1_FET	->SetTestResult(site, 0, (Tovp_Recovery_CC1FET_T[site]	*1.0e-3f));   // 19-2
    TOVP_Recovery_CC1_DB	->SetTestResult(site, 0, (Tovp_Recovery_CC1DB_T[site]		*1.0e-3f));   // 19-3
    TOVP_Recovery_CC2_FET	->SetTestResult(site, 0, (Tovp_Recovery_CC2FET_T[site]	*1.0e-3f));   // 19-4
    TOVP_Recovery_CC2_DB	->SetTestResult(site, 0, (Tovp_Recovery_CC2DB_T[site]		*1.0e-3f));   // 19-5
 	}
	pwrZero();
	pwrSW_off();
	rlyC.SetOn(-1);
...
DUT_API int SBU_Timing_Test(short funcindex, LPCTSTR funclabel)	{
  ...
  rlyC.SetOn(-1);
	delay_ms(1);
	rlyC.SetOn(FPVI2_nonKelvin, VPWR_Cap, FLTB_100K, V33E_Cap, V33E_Fovi, FLTB_qtmuAB_SBU1, RPD1_Fovi, RPD2_Fovi, -1);	// C_SBU1(0A) TO SBU1(0B)
	delay_ms(1);
	qtmu0.SetStartInput(QTMU_PLUS_IMPEDANCE_1M, QTMU_PLUS_VRNG_5V, QTMU_PLUS_FILTER_PASS);
  qtmu0.SetStopInput(QTMU_PLUS_IMPEDANCE_1M, QTMU_PLUS_VRNG_5V, QTMU_PLUS_FILTER_PASS);
